...
But if all truthbearers (all of which are meaningbearers) have the same truthmaker then it might appear that they all mean the same thing.\footnotemark\ 
...
Declarative sentences do seem to be `properly' true or false, even if only secondarily, so this is not a promising view and is noted only for completeness.
}%}}}
