...
% Do I ?!?!?!?!?!?!?! Clarify how (because when I'm done this will probably be different)
...
% I might want to push this more. ' In fact, any reasonable formulation of corrspondence theory MUST...'
...
% NOTE this would be good!! you could use 'seems faily likely' rather than 'motivated by intuition'
...
% NOTE If you're going to include this footnote, it should be slightly more formal.
...
% the 'contradictions' part could be clearer?
...
% I might have to cut this part if it all gets too long... (YEP) {{{
% There are a number of ways a theory could account for this.
% % check this with sentences / meaningbearers
...
% NOTE This needs more justification!!!
