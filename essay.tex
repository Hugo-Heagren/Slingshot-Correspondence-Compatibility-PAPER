...
Since this will run for any two senteces with the same truth value, all true sentences must be made trueh by the same truthmaker.

Davidson calls this truthmaker the `Great Fact'. (REFER HERE!) Others have identified it with truth (or for Frege the object `the True'(REFER HERE)) or with a general state of affairs of the universe (further REFER HERE from the Stainton paper).
