...
\parencite[753]{Davidson_1969}
	...
	What a complex singular term refers to will not change if a part of it which is a singular term is replaced with another singular term with the same reference.
	\\(e.g. if a name in a sentence is replaced with a different name for the same thing, the sentence's referenece will not change.)
	\end{thesis}
