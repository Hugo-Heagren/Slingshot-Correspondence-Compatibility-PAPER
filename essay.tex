...
Without further premises the argument can then be exptended to show that if the correspondence theory is true, then all sentences with the same truth value must correspond to the same truthmaker.
...
% Clearly different (true) sentences are different in some ways (they are composed of different words and mean different things).
...
Put another way: that true sentences actually differ in some way in which they could not differ if they all had the same truthmaker.
Intuitivley, meaning might be such a difference: one migh think different true sentences mean different things, but sentences with the same truthmaker always mean the same thing.

The conclusion of the slingshot argument then shows that all true sentences are about the same thing, which is absurd!
Davidson expresses a similar sentiment: that if two sentences correspond to the same thing then the statment of each is identical with that of the other.
...
% the point: different true sentences are different in sopme important way (e.g. meaning), but the argument shows that all true sentences correspond to the same truth-maker and prima facie this shows that actually all the tru sentences are NOT different in the important way.
